  ...
  return (
    <>
      ...
      <secion className='flex justify-between leading-8 ml-6 mr-6 mt-7 text-lg' style={{fontFamily:'Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif', textAlign:"justify"}}>
        <div className=' flex flex-col gap-3 w-auto py-3 px-5'>
       <p>
       If you’re wondering whether you are overthinking a particular situation or
concern, there are a few things you can look for. Signs of overthinking include: </p>
<ol style={{listStyleType:"lower-alpha", }} className='ms-5' > 
...
for a solution. 
Imagine a storm is coming. Here’s the difference between overthinking and problem-solving: </p>
